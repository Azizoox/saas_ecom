<?php $__env->startSection('title', 'Constructeur de Page d\'Accueil'); ?>
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if(isset($shops) && $shops->count() > 1): ?>
                    <form method="GET" action="<?php echo e(route('builder.index')); ?>" class="d-flex align-items-center gap-2">
            ...
            <?php else: ?>
                <div id="components-list" class="sortable-container">
                    <?php $__currentLoopData = $components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card shadow-sm mb-3 component-item" data-id="<?php echo e($component->id); ?>">
                            <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-grip-vertical handle cursor-pointer text-muted me-3"></i>
                                    <div>
                                        <span class="fw-bold text-uppercase small"><?php echo e($component->type); ?></span>
                                        ...
                                        <div class="small text-muted">
                                            <?php switch($component->type):
                                                case ('slider'): ?>
                                                    <?php echo e(count($component->content['slides'] ?? [])); ?> slide(s)
                                                    <?php break; ?>
                                                <?php case ('categories'): ?>
                                                    Style: <?php echo e($component->content['style'] ?? 'grid'); ?>

                                                    <?php break; ?>
                                                <?php case ('reviews'): ?>
                                                    <?php echo e(count($component->content['reviews'] ?? [])); ?> avis
                                                    <?php break; ?>
                                                <?php default: ?>
                                                    Configuré
                                            <?php endswitch; ?>
                                ...
                                <div class="btn-group">
                                    <form action="<?php echo e(route('builder.destroy', $component)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <form action="<?php echo e(route('builder.update', $component)); ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-check form-switch mb-4">
                                                <input class="form-check-input" type="checkbox" name="is_active" 
                                                       id="active-<?php echo e($component->id); ?>" 
                                                       <?php echo e($component->is_active ? 'checked' : ''); ?>>
                                                <label class="form-check-label fw-bold" for="active-<?php echo e($component->id); ?>">
...
<script>
    ...
    addComponentModal.addEventListener('show.bs.modal', function (event) {
        ...
        const shopId = activeShopEl ? activeShopEl.value : '<?php echo e($shop->id); ?>';
