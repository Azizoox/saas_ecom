...
<body>
                        ...
                        <div class="cart-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p class="text-muted mb-1"><?php echo $item->product->short_description ?? Str::limit($item->product->description, 100); ?></p>
                                    <small class="text-muted">Prix unitaire: <?php echo e(number_format($item->product->price, 2, ',', ' ')); ?> TND</small>
                                </div>
                                <div class="col-md-2">
                                    <div class="quantity-controls">
                                        <button class="quantity-btn btn-decrease" data-product-id="<?php echo e($item->product_id); ?>">
                                        ...
                                        <button class="quantity-btn btn-increase" data-product-id="<?php echo e($item->product_id); ?>">
            ...
            <div class="col-lg-4">
                <div class="cart-summary">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong><?php echo e(number_format($totalPrice, 2, ',', ' ')); ?> TND</strong>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        <strong>Total:</strong>
                        <strong class="fs-5"><?php echo e(number_format($totalPrice, 2, ',', ' ')); ?> TND</strong>
                    </div>
                    
                    <a href="<?php echo e(route('shop.checkout', ['subdomain' => $shop->subdomain ?? request()->route('subdomain', '')])); ?>" class="btn btn-primary checkout-btn w-100">
    ...
    <script>
        ...
        function updateQuantity(productId, quantity) {
            fetch('<?php echo e(route("shop.cart.update", ["subdomain" => $shop->subdomain])); ?>', {
                method: 'POST',
                headers: {
        ...
        function removeFromCart(productId) {
            fetch('<?php echo e(route("shop.cart.remove", ["subdomain" => $shop->subdomain])); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function clearCart() {
            fetch('<?php echo e(route("shop.cart.clear", ["subdomain" => $shop->subdomain])); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
