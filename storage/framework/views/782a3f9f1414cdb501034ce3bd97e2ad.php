<?php $__env->startSection('title', 'Panier - ' . ($shop->name ?? 'Ma Boutique')); ?>
...
<div class="cart-wrapper">
    ...
    <div class="cart-layout">
        ...
        <div>
            <div id="cart-items-list">
                ...
                <div class="cart-item" id="cart-item-<?php echo e($item->product_id); ?>" data-price="<?php echo e($item->product->price); ?>">
                    ...
                    <div>
                        ...
                        <div class="item-desc"><?php echo Str::limit(strip_tags($item->product->short_description ?? $item->product->description ?? ''), 80); ?></div>
                        <div class="item-unit-price"><?php echo e(number_format($item->product->price, 2, ',', ' ')); ?> TND / unité</div>
                    </div>

                    
                    <div class="qty-ctrl" id="qty-ctrl-<?php echo e($item->product_id); ?>">
                        <button class="qty-btn btn-decrease"
                                data-pid="<?php echo e($item->product_id); ?>"
                                data-min="1"
                        ...
                        <button class="qty-btn btn-increase"
                                data-pid="<?php echo e($item->product_id); ?>"
                                data-max="<?php echo e($item->product->stock); ?>"
                    ...
                    <div class="item-right">
                        <span class="item-total" id="item-total-<?php echo e($item->product_id); ?>">
                            <?php echo e(number_format($item->product->price * $item->quantity, 2, ',', ' ')); ?> TND
                        </span>
                        <button class="btn-remove" data-pid="<?php echo e($item->product_id); ?>">
        ...
        <div>
            <div class="summary-card">
                ...
                <div class="summary-row">
                    ...
                    <strong id="summary-subtotal"><?php echo e(number_format($totalPrice, 2, ',', ' ')); ?> TND</strong>
                </div>
                <div class="summary-row">
                    <span>Livraison</span>
                ...
                <div class="summary-row total">
                    <span>Total</span>
                    <span id="summary-total"><?php echo e(number_format($totalPrice, 2, ',', ' ')); ?> TND</span>
                </div>

                <a href="<?php echo e(route('shop.checkout', ['subdomain' => $shop->subdomain ?? request()->route('subdomain', '')])); ?>"
                   class="checkout-btn">
    ...
    <div class="empty-state" id="empty-state">
        ...
        <a href="<?php echo e(route('shop.index', ['subdomain' => $shop->subdomain ?? ''])); ?>" class="btn-shop">
...
(function () {
    ...
    /* ───────────── CONFIG ───────────── */
    const ROUTES = {
        update : '<?php echo e(route("shop.cart.update", ["subdomain" => $shop->subdomain])); ?>',
        remove : '<?php echo e(route("shop.cart.remove", ["subdomain" => $shop->subdomain])); ?>',
        clear  : '<?php echo e(route("shop.cart.clear",  ["subdomain" => $shop->subdomain])); ?>',
        shop   : '<?php echo e(route("shop.index",        ["subdomain" => $shop->subdomain ?? ""])); ?>'
    };
...
<?php echo $__env->make('shop.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/shop/cart.blade.php ENDPATH**/ ?>