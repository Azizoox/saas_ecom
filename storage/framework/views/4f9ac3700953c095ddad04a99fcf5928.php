...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="exemple@email.com">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(Route::has('register')): ?>
                            <div class="register-link">
                                Vous n'avez pas de compte ? <a href="<?php echo e(route('register')); ?>">Créez-en un gratuitement</a>
                            </div>
                        <?php endif; ?>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views\auth\login.blade.php ENDPATH**/ ?>