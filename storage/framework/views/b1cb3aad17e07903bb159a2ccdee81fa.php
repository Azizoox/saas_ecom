...
<section class="cat-section">
    <div class="cat-container">
        ...
        <div class="cat-header">
            ...
            <h2 class="cat-title"><?php echo e($content['title']); ?></h2>
        ...
        <?php if($style === 'slider'): ?>
            ...
            <div class="cat-slider-wrapper">
                ...
                <div class="cat-slider" id="catSlider">
                    <?php $__empty_1 = true; $__currentLoopData = $categoriesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $productCount = $category->products()->where('is_active', true)->count(); ?>
                    <a href="<?php echo e(route('shop.index', ['subdomain' => $shop->subdomain, 'category' => $category->slug])); ?>"
                       class="cat-slide" style="--i:<?php echo e($i); ?>">
                        <div class="cat-card cat-card--slim">
                            <div class="cat-icon-wrap">
                                <?php if($category->image): ?>
                                    <img src="<?php echo e(Storage::url($category->image)); ?>" alt="<?php echo e($category->name); ?>" class="cat-img">
                                <?php elseif($category->icon): ?>
                                    <img src="<?php echo e(Storage::url($category->icon)); ?>" alt="<?php echo e($category->name); ?>" class="cat-img cat-img--contain">
                                <?php else: ?>
                            ...
                            <?php if($productCount > 0): ?>
                                <span class="cat-count"><?php echo e($productCount); ?></span>
                            <?php endif; ?>
                        </div>
                    </a>
        ...
        <?php else: ?>
            ...
            <div class="cat-grid">
                ...
                <?php $productCount = $category->products()->where('is_active', true)->count(); ?>
                <a href="<?php echo e(route('shop.index', ['subdomain' => $shop->subdomain, 'category' => $category->slug])); ?>"
                   class="cat-item" style="--i:<?php echo e($i); ?>">
                    <div class="cat-card">
                        <div class="cat-icon-wrap">
                            <?php if($category->image): ?>
                                <img src="<?php echo e(Storage::url($category->image)); ?>" alt="<?php echo e($category->name); ?>" class="cat-img">
...
</script><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/shop/components/categories.blade.php ENDPATH**/ ?>