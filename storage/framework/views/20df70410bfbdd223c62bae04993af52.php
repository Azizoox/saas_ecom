        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100 stat-card">
                <div class="card-body">
                    ...
                    <h3 class="mb-2"><?php echo e($stats['users_count']); ?></h3>
                    <small class="text-success">
                        <i class="bi bi-arrow-up"></i> <?php echo e($stats['users_today']); ?> aujourd'hui
                    </small>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100 stat-card">
                <div class="card-body">
                    ...
                    <h3 class="mb-2"><?php echo e($stats['shops_count']); ?></h3>
                    <small class="text-info">
                        <?php echo e($stats['shops_active']); ?> actives • <?php echo e($stats['shops_inactive']); ?> inactives
                    </small>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100 stat-card">
                <div class="card-body">
                    ...
                    <h3 class="mb-2"><?php echo e($stats['products_count']); ?></h3>
                    <small class="text-success">
                        <?php echo e($stats['products_active']); ?> actifs
                    </small>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100 stat-card">
                <div class="card-body">
                    ...
                    <h3 class="mb-2"><?php echo e($stats['orders_count']); ?></h3>
                    <small class="text-warning">
                        <?php echo e($stats['orders_pending']); ?> en attente
                    </small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100 bg-primary text-white">
                <div class="card-body">
                    ...
                    <h2 class="mb-2"><?php echo e(number_format($stats['orders_total_amount'], 2)); ?> TND</h2>
                    <small class="opacity-90">
                        Mois: <?php echo e(number_format($stats['orders_this_month'], 2)); ?> TND
                    </small>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100 bg-success text-white">
                <div class="card-body">
                    ...
                    <h2 class="mb-2"><?php echo e(number_format($stats['average_order_value'], 2)); ?> TND</h2>
                    <small class="opacity-90">
                        <?php echo e($stats['orders_completed']); ?> commandes complétées
                    </small>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100 bg-danger text-white">
                <div class="card-body">
                    ...
                    <h2 class="mb-2"><?php echo e($stats['orders_cancelled']); ?></h2>
                    <small class="opacity-90">
    ...
    <div class="row g-3 mb-4">
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h5><?php echo e($stats['orders_count'] - $stats['orders_completed'] - $stats['orders_cancelled']); ?></h5>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <div style="font-size: 2rem; margin-bottom: 10px;">✅</div>
                    <h5><?php echo e($stats['orders_completed']); ?></h5>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <div style="font-size: 2rem; margin-bottom: 10px;">📦</div>
                    <h5><?php echo e($stats['categories_count']); ?></h5>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <div style="font-size: 2rem; margin-bottom: 10px;">👥</div>
                    <h5><?php echo e($stats['users_this_month']); ?></h5>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100">
                            ...
                            <?php $__currentLoopData = $recentUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <span class="badge bg-secondary"><?php echo e($u->role ?? 'Client'); ?></span>
                                    </div>
                                </li>
                ...
                <div class="card-footer bg-light">
                    <a href="<?php echo e(route('super-admin.users.index')); ?>" class="btn btn-sm btn-primary w-100">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100">
                            ...
                            <?php $__currentLoopData = $recentOrders->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <span class="badge bg-<?php echo e($o->status === 'new' ? 'warning' : ($o->status === 'completed' ? 'success' : 'info')); ?>"><?php echo e($o->status); ?></span>
                                    </div>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                ...
                <div class="card-footer bg-light">
                    <a href="<?php echo e(route('orders.index')); ?>" class="btn btn-sm btn-warning w-100">
