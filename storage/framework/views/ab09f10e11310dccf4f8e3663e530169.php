...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($shop->id); ?>" <?php echo e((old('shop_id', $category->shop_id) == $shop->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="order" name="order" value="<?php echo e(old('order', $category->order)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                      id="description" name="description" rows="3"><?php echo e(old('description', $category->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php if($category->icon): ?>
                                        <div class="mt-2">
                                            ...
                                            <br>
                                            <img src="<?php echo e(Storage::url($category->icon)); ?>" alt="Current icon" style="max-width: 100px; max-height: 100px;">
                                        </div>
                                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php if($category->image): ?>
                                        <div class="mt-2">
                                            ...
                                            <br>
                                            <img src="<?php echo e(Storage::url($category->image)); ?>" alt="Current image" style="max-width: 150px; max-height: 150px;">
                                        </div>
                                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo e(route('categories.index')); ?>" class="btn btn-secondary me-2">Annuler</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views\categories\edit.blade.php ENDPATH**/ ?>