...
<?php $__env->startSection('title', 'Register - ' . $shop->name); ?>
...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-10 px-4">
    <div class="w-full max-w-4xl rounded-2xl overflow-hidden shadow-xl flex" style="min-height: 580px;">
        ...
        <div class="brand-panel relative hidden md:flex flex-col justify-between p-10 w-5/12 flex-shrink-0 overflow-hidden">
            ...
            <div class="relative z-10 flex-1 flex flex-col justify-center py-8">
                ...
                <div class="space-y-3">
                    ...
                    <div class="feature-item">
                        ...
                        <span class="text-white/70 text-sm"><?php echo e($feature); ?></span>
                    </div>
            ...
            <div class="relative z-10">
                <div class="flex -space-x-2 mb-2">
                    <?php $__currentLoopData = ['J','M','A','S']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $initial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="w-7 h-7 rounded-full bg-white/20 border-2 border-white/30 flex items-center justify-center text-white text-xs font-medium"><?php echo e($initial); ?></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="flex-1 bg-white p-8 md:p-10 flex flex-col justify-center">
            ...
            <form method="POST" action="<?php echo e(route('shop.register.store', ['subdomain' => $shop->subdomain])); ?>" novalidate>
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-2 gap-3 mb-4">
                    <div>
                        ...
                        <input
                            ...
                            class="input-field <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="input-field <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="mt-4 text-center text-sm text-gray-500">
                    ...
                    <a href="<?php echo e(route('shop.login', ['subdomain' => $shop->subdomain])); ?>" class="color font-medium hover:underline">Sign in</a>
                </p>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('shop.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/shop/auth/register.blade.php ENDPATH**/ ?>