                ...
                <div class="card-body">
                    <?php if($currentSession): ?>
                        ...
                        <div class="row g-3 mb-4" id="products-grid">
                            ...
                            <?php $__currentLoopData = \App\Models\Product::where('shop_id', $shop->id)->where('is_active', true)->limit(12)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-3 col-sm-4 col-6">
                                    <div class="card product-card h-100" data-product-id="<?php echo e($product->id); ?>" data-product-name="<?php echo e($product->name); ?>" data-product-price="<?php echo e($product->price); ?>">
                                       <img src="<?php echo e(asset('storage/' . $product->image)); ?>"  alt="<?php echo e($product->name); ?>" class="card-img-top" style="height: 120px; object-fit: cover;">
                                        <div class="card-body p-2">
                                            <h6 class="card-title small mb-1"><?php echo e(Str::limit($product->name, 20)); ?></h6>
                                            <p class="card-text small text-muted mb-1"><?php echo e($product->sku); ?></p>
                                            <p class="card-text fw-bold text-primary"><?php echo e(number_format($product->price, 3, '.', ' ')); ?> TND</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="d-flex justify-content-between align-items-center mb-2 pb-2 border-bottom">
                            <div>
                                <small><?php echo e($order->formatted_order_number); ?></small><br>
                                <small class="text-muted"><?php echo e($order->created_at->format('H:i')); ?></small>
                            </div>
                            <div class="text-end">
                                <strong><?php echo e(number_format($order->total_amount, 3, '.', ' ')); ?> TND</strong><br>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('product-search').addEventListener('input', function() {
        ...
        if (query.length >= 2) {
            fetch(`<?php echo e(route('pos.search.products')); ?>?q=${encodeURIComponent(query)}`)
                .then(response => response.json())
                .then(products => {
                    // Clear grid
