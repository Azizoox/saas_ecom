...
<div x-data="chatbot('<?php echo e($shop->subdomain ?? ''); ?>', '<?php echo e($shop->name ?? config('app.name')); ?>')" style="position:fixed;bottom:24px;right:24px;z-index:9999;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
...
</script><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/components/shop/chatbot.blade.php ENDPATH**/ ?>