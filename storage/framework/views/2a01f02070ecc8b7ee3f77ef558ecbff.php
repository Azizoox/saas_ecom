...
<head>
    ...
    <title>Dashboard - <?php echo e(config('app.name', 'Shoopino')); ?></title>
        ...
        <nav class="sidebar" id="sidebar">
            <div class="sidebar-brand">
                <h4>
                    ...
                    <img src="<?php echo e(asset('images/img.jpg')); ?>" alt="" width="55" height="55" class="rounded-circle">
            ...
            <div class="sidebar-nav">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('super-admin.*') ? 'active' : ''); ?>" href="<?php echo e(route('super-admin.dashboard')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('builder.*') ? 'active' : ''); ?>" href="<?php echo e(route('builder.index')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('invoices.*') ? 'active' : ''); ?>" href="<?php echo e(route('invoices.index')); ?>">
                            <i class="bi bi-receipt"></i>
                            <span class="nav-text">Factures</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('logistics.pickups') ? 'active' : ''); ?>" href="<?php echo e(route('logistics.pickups')); ?>">
                            <i class="bi bi-box-arrow-in-down"></i>
                            <span class="nav-text">Ramassage</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('logistics.packings') ? 'active' : ''); ?>" href="<?php echo e(route('logistics.packings')); ?>">
                            <i class="bi bi-box2"></i>
                            <span class="nav-text">Emballage</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('logistics.returns') ? 'active' : ''); ?>" href="<?php echo e(route('logistics.returns')); ?>">
                            <i class="bi bi-arrow-counterclockwise"></i>
                            <span class="nav-text">Retours</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('stats.*') ? 'active' : ''); ?>" href="<?php echo e(route('stats.sales')); ?>">
                    ...
                    <li class="nav-item ms-4">
                        <a class="nav-link <?php echo e(request()->routeIs('pos.orders') ? 'active' : ''); ?>" href="<?php echo e(route('pos.orders')); ?>">
...
<?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>