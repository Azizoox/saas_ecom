...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if(Route::has('register')): ?>
                    <div class="form-footer">
                        Pas encore de compte ? <a href="<?php echo e(route('register')); ?>">Créer un compte gratuitement →</a>
                    </div>
                <?php endif; ?>
            </form>
        </div>
...
<?php echo $__env->make('layouts.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/auth/login.blade.php ENDPATH**/ ?>