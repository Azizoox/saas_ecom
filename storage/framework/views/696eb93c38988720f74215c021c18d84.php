...
unset($__errorArgs, $__bag); ?>" name="first_name" value="<?php echo e(old('first_name')); ?>" required autofocus placeholder="Votre prénom">
...
unset($__errorArgs, $__bag); ?>" name="last_name" value="<?php echo e(old('last_name')); ?>" required placeholder="Votre nom">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="shop_name" type="text" class="form-control <?php $__errorArgs = ['shop_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="shop_name" value="<?php echo e(old('shop_name')); ?>" required placeholder="Ma Super Boutique">
...
unset($__errorArgs, $__bag); ?>" name="subdomain" value="<?php echo e(old('subdomain')); ?>" required placeholder="ma-boutique">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="login-link">
                        Vous avez déjà un compte ? <a href="<?php echo e(route('login')); ?>">Connectez-vous ici</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/auth/register.blade.php ENDPATH**/ ?>