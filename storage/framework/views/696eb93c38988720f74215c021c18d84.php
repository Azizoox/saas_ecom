                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="first_name" type="text" class="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl font-medium text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none transition-colors <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>" name="first_name" value="<?php echo e(old('first_name')); ?>" required autofocus placeholder="Prénom">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="last_name" type="text" class="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl font-medium text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none transition-colors <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="last_name" value="<?php echo e(old('last_name')); ?>" required placeholder="Nom">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" class="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl font-medium text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none transition-colors <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required placeholder="exemple@email.com">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="phone" type="tel" class="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl font-medium text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none transition-colors <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>" required placeholder="+216 XX XXX XXX">
                    </div>
            ...
            <div class="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input id="shop_name" type="text" class="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl font-medium text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none transition-colors <?php $__errorArgs = ['shop_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="shop_name" value="<?php echo e(old('shop_name')); ?>" required placeholder="Ma Super Boutique" oninput="autoFillSubdomain(this.value)">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="flex border-2 <?php $__errorArgs = ['subdomain'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-slate-200 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-xl overflow-hidden focus-within:border-blue-500 transition-colors bg-white">
                        <input id="subdomain" type="text" class="flex-1 px-4 py-3 font-medium text-slate-900 placeholder-slate-400 focus:outline-none" name="subdomain" value="<?php echo e(old('subdomain')); ?>" required placeholder="ma-boutique">
            ...
            <div class="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input id="password" type="password" class="w-full pl-12 pr-12 py-3 border-2 border-slate-200 rounded-xl font-medium text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none transition-colors <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password" required placeholder="Minimum 8 caractères" oninput="checkStrength(this.value)">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center pt-6 border-t border-slate-200">
                <p class="text-slate-600 text-sm">Vous avez déjà un compte ? <a href="<?php echo e(route('login')); ?>" class="font-bold text-blue-600 hover:text-orange-500 transition-colors">Connectez-vous →</a></p>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views/auth/register.blade.php ENDPATH**/ ?>