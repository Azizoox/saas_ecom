...
unset($__errorArgs, $__bag); ?>" id="sku" name="sku" value="<?php echo e(old('sku')); ?>">
                                        <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="reference" name="reference" value="<?php echo e(old('reference')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="barcode" name="barcode" value="<?php echo e(old('barcode')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="supplier" name="supplier" value="<?php echo e(old('supplier')); ?>" list="suppliers">
...
unset($__errorArgs, $__bag); ?>" id="brand" name="brand" value="<?php echo e(old('brand')); ?>" list="brands">
                                        <datalist id="brands">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea style="height: 500px;" class="form-control <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="edi" rows="15" name="description" rows="6"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-3" id="galleryPreview"></div>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" id="meta_title" name="meta_title" value="<?php echo e(old('meta_title')); ?>" maxlength="255">
...
unset($__errorArgs, $__bag); ?>" id="meta_description" name="meta_description" rows="3" maxlength="160"><?php echo e(old('meta_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="meta_keywords" name="meta_keywords" value="<?php echo e(old('meta_keywords')); ?>">
...
ClassicEditor
    ...
    ClassicEditor
    .create(document.querySelector('#edi'), {
        toolbar: [
            'undo','redo',
            '|','bold','italic','underline','strikethrough',
            '|','fontSize','fontColor','fontBackgroundColor',
