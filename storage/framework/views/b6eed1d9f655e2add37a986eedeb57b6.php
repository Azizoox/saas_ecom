        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="content[title]" class="form-control" 
                       value="<?php echo e($content['title'] ?? 'Nos Catégories'); ?>" 
            ...
            <div class="col-md-6">
                ...
                <select name="content[style]" class="form-select">
                    <option value="grid" <?php echo e(($content['style'] ?? 'grid') === 'grid' ? 'selected' : ''); ?>>
                        Grille (statique)
                    </option>
                    <option value="slider" <?php echo e(($content['style'] ?? 'grid') === 'slider' ? 'selected' : ''); ?>>
                        Slider (défilant)
                    </option>
                </select>
...
<?php /**PATH C:\Users\ahach\OneDrive\Bureau\shoopino\resources\views\dashboard\builder\partials\categories.blade.php ENDPATH**/ ?>