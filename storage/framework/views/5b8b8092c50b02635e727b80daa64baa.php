...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
    ...
    <?php if(session('success')): ?>
        <div class="mb-4 rounded-2xl bg-emerald-50 px-4 py-3 text-emerald-800 ring-1 ring-inset ring-emerald-200">
            <div class="flex items-start gap-3">
                ...
                <div class="text-sm font-semibold"><?php echo e(session('success')); ?></div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div id="general-tab" class="tab-content">
        <form action="<?php echo e(route('settings.general')); ?>" method="POST" enctype="multipart/form-data" class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="mt-4">
                ...
                <textarea name="description" id="description" rows="3"
                    class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('description', $shop->description)); ?></textarea>
            </div>
            ...
            <div class="rounded-2xl bg-slate-50 ring-1 ring-inset ring-slate-200 p-4">
                ...
                <?php if($shop->logo): ?>
                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($shop->logo)); ?>" alt="Logo" class="mb-3 h-20 rounded-xl bg-white ring-1 ring-inset ring-slate-200 p-2">
                <?php endif; ?>
            ...
            <div class="rounded-2xl bg-slate-50 ring-1 ring-inset ring-slate-200 p-4">
                ...
                <?php if($shop->favicon): ?>
                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($shop->favicon)); ?>" alt="Favicon" class="mb-3 h-10 w-10 rounded-xl bg-white ring-1 ring-inset ring-slate-200 p-2">
                <?php endif; ?>
    ...
    <div id="display-tab" class="tab-content hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            <div class="lg:col-span-8">
                <form action="<?php echo e(route('settings.display')); ?>" method="POST" class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 p-6">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="rounded-2xl bg-slate-50 ring-1 ring-inset ring-slate-200 p-4">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" name="primary_color" id="primary_color" value="<?php echo e($currentPrimaryColor); ?>" required
                               class="h-12 w-16 cursor-pointer rounded-xl border border-slate-300 bg-white shadow-sm">
                        <input type="text" id="primary_color_text" value="<?php echo e($currentPrimaryColor); ?>" readonly
                ...
                <div class="rounded-2xl bg-white ring-1 ring-inset ring-slate-200 p-4">
                    ...
                    <div class="grid grid-cols-3 rounded-2xl bg-slate-50 ring-1 ring-inset ring-slate-200 p-1">
                        <label class="group cursor-pointer">
                            <input class="sr-only" type="radio" name="display_mode" value="light" <?php if($currentDisplayMode === 'light'): echo 'checked'; endif; ?>>
                        ...
                        <label class="group cursor-pointer">
                            <input class="sr-only" type="radio" name="display_mode" value="dark" <?php if($currentDisplayMode === 'dark'): echo 'checked'; endif; ?>>
                            <span class="flex items-center justify-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold ring-1 ring-inset ring-transparent text-slate-700 group-has-[:checked]:bg-white group-has-[:checked]:text-slate-900 group-has-[:checked]:ring-slate-200">
                        ...
                        <label class="group cursor-pointer">
                            <input class="sr-only" type="radio" name="display_mode" value="auto" <?php if($currentDisplayMode === 'auto'): echo 'checked'; endif; ?>>
                            <span class="flex items-center justify-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold ring-1 ring-inset ring-transparent text-slate-700 group-has-[:checked]:bg-white group-has-[:checked]:text-slate-900 group-has-[:checked]:ring-slate-200">
                            ...
                            <div class="p-4 bg-white text-slate-900">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="h-8 w-8 rounded-xl" id="previewAccentSwatch" style="background: <?php echo e($currentPrimaryColor); ?>;"></div>
                                        <div class="text-sm font-semibold">Boutique</div>
                                    </div>
                                    <span class="text-xs text-slate-500" id="previewModeLabel"><?php echo e(strtoupper($currentDisplayMode)); ?></span>
                                </div>
                                <div class="mt-4 grid grid-cols-2 gap-2">
                                    <button type="button" class="rounded-xl px-3 py-2 text-sm font-semibold text-white" id="previewPrimaryBtn"
                                            style="background: <?php echo e($currentPrimaryColor); ?>;">
                                        Bouton
                                    </button>
