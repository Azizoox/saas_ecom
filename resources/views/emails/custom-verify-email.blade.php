...
<div class="wrapper">
    ...
    <div class="card">
        ...
        <div class="body">
            ...
            <!-- CTA -->
            <div class="btn-wrap">
                <a href="{{ $url }}" class="btn">Confirmer mon email &rarr;</a>
            </div>

            <!-- Expiry -->
            <div class="expiry">
                <span class="expiry-icon">⏱</span>
                <p>Ce lien expire dans <strong>{{ $expireMinutes }} minutes</strong></p>
            </div>

            <!-- Note -->
            <p class="note">
                Vous n'avez pas créé de compte chez <strong>{{ $appName }}</strong> ? Ignorez simplement cet email.
            </p>
