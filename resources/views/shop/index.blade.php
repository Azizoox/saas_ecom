    ...
    <!-- <div class="hero-section">
        <div class="container">
            <div class="hero-content fade-in-up">
                @if($shop->logo)
                    <img src="{{ \Illuminate\Support\Facades\Storage::url($shop->logo) }}" alt="{{ $shop->name }}" class="mb-4" style="max-height: 120px;">
                @endif
                <h1 class="hero-title">Bienvenue sur {{ $shop->name }}</h1>
    ...
    <div class="container" id="products">
        @if(isset($products) && $products->count() > 0)
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 fade-in-up" style="animation-delay: {{ $loop->index * 0.1 }}s">
                            ...
                            <div class="product-footer">
                                @if($product->isInStock())
                                    <span class="stock-badge bg-success-subtle text-success">
                                        <i class="bi bi-check-circle me-1"></i>{{ $product->stock }} disponible(s)
                                    </span>
                                @else
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <h5 class="text-uppercase mb-4 fw-bold">{{ $shop->name }}</h5>
                    @if($shop->description)
                        <p class="mb-3">{{ Str::limit($shop->description, 150) }}</p>
                    @endif
                    @if($shop->company_name)
                        <p class="mb-2"><strong>{{ $shop->company_name }}</strong></p>
                    @endif
                    @if($shop->tax_id)
                        <p class="mb-0"><small>MF: {{ $shop->tax_id }}</small></p>
                    @endif
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    @if($shop->contact_email)
                        <p class="mb-3">
                            ...
                            <a href="mailto:{{ $shop->contact_email }}" class="text-decoration-none">
                                {{ $shop->contact_email }}
                            </a>
                        </p>
                    @endif
                    @if($shop->contact_phone)
                        <p class="mb-3">
                            ...
                            <a href="tel:{{ $shop->contact_phone }}" class="text-decoration-none">
                                {{ $shop->contact_phone }}
                            </a>
                        </p>
                    @endif
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        @if($shop->settings && $shop->settings->facebook_url)
                            <a href="{{ $shop->settings->facebook_url }}" target="_blank" class="social-link">
                                <i class="bi bi-facebook"></i>
                            </a>
                        @endif
                        @if($shop->settings && $shop->settings->instagram_url)
                            <a href="{{ $shop->settings->instagram_url }}" target="_blank" class="social-link">
                                <i class="bi bi-instagram"></i>
                            </a>
                        @endif
                        @if($shop->settings && $shop->settings->tiktok_url)
                            <a href="{{ $shop->settings->tiktok_url }}" target="_blank" class="social-link">
                                <i class="bi bi-tiktok"></i>
                            </a>
                        @endif
                        @if($shop->settings && $shop->settings->twitter_url)
                            <a href="{{ $shop->settings->twitter_url }}" target="_blank" class="social-link">
                                <i class="bi bi-twitter-x"></i>
                            </a>
                        @endif
                        @if($shop->settings && $shop->settings->youtube_url)
                            <a href="{{ $shop->settings->youtube_url }}" target="_blank" class="social-link">
                                <i class="bi bi-youtube"></i>
                            </a>
                        @endif
                        @if($shop->settings && $shop->settings->whatsapp_number)
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $shop->settings->whatsapp_number) }}" target="_blank" class="social-link">
            ...
            <div class="row mt-5 pt-4 border-top border-secondary">
                <div class="col-md-12 text-center">
                    <p class="mb-2">&copy; {{ date('Y') }} {{ $shop->name }}. Tous droits réservés.</p>
