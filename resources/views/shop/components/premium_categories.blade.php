            ...
            <div class="col-md-3">
                <div class="card h-100 border-0 shadow-sm overflow-hidden position-relative">
                    <span class="position-absolute top-0 start-0 m-2 badge bg-warning text-dark">
                        <i class="bi bi-star-fill me-1"></i> {{ $badge_text }}
                    </span>
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('shop.index', ['subdomain' => $shop->subdomain, 'category' => $category]) }}" class="btn btn-sm btn-outline-primary mt-2">Découvrir</a>
                    </div>
                </div>
            </div>
        @endforeach
