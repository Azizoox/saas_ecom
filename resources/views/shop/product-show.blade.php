...
<body>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('shop.index', ['subdomain' => $shop->subdomain]) }}#products">Produits</a>
                    </li>
            ...
            <div class="col-lg-6">
                <div class="product-info">
                    ...
                    <div class="product-meta">
                        ...
                        <div class="meta-item">
                            <i class="bi bi-tag"></i>
                            <span>Marque: <strong>{{ $product->brand }}</strong></span>
                        </div>
                        @endif
                        ...
                        <div class="meta-item">
                            ...
                            <span>Réf: <strong>{{ $product->reference }}</strong></span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="alert alert-info border-0" style="background: #eff6ff;">
                        <i class="bi bi-info-circle me-2"></i>{!! $product->short_description !!}
                    </div>
                    @endif
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product-card-small">
                        <a href="{{ route('shop.product', ['subdomain' => $shop->subdomain, 'id' => $relatedProduct->id]) }}">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    @if($shop->contact_email)
                        <p class="mb-3">
                            ...
                            <a href="mailto:{{ $shop->contact_email }}" class="text-white text-decoration-none">
                                {{ $shop->contact_email }}
                            </a>
                        </p>
                    @endif
                    @if($shop->contact_phone)
                        <p class="mb-3">
                            ...
                            <a href="tel:{{ $shop->contact_phone }}" class="text-white text-decoration-none">
                                {{ $shop->contact_phone }}
                            </a>
                        </p>
                    @endif
    ...
    <script>
        ...
        document.querySelector('.btn-add-cart')?.addEventListener('click', function() {
            ...
            const productId = {{ $product->id }}; // Assuming the product ID is available
            const button = this;
