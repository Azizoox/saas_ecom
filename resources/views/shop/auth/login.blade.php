    ...
    <div class="w-full max-w-3xl rounded-2xl overflow-hidden shadow-xl flex" style="min-height: 520px;">
        ...
        <div class="flex-1 bg-white p-8 md:p-10 flex flex-col justify-center">
            ...
            <div class="flex items-center gap-2 mb-6 md:hidden">
                ...
                <span class="font-semibold text-sm text-gray-800">{{ $shop->name }}</span>
            </div>
            ...
            <form method="POST" action="{{ route('shop.login.store', ['subdomain' => $shop->subdomain]) }}" novalidate>
                @csrf
                ...
                <div class="mb-4">
                    <div class="flex items-center justify-between mb-1.5">
                        ...
                        <a href="{{ route('shop.password.request', ['subdomain' => $shop->subdomain]) }}"
                ...
                <p class="mt-4 text-center text-sm text-gray-500">
                    ...
                    <a href="{{ route('shop.register', ['subdomain' => $shop->subdomain]) }}" class="create  font-medium hover:underline">Create one</a>
                </p>
            </form>
        </div>
