    ...
    <div class="mx-auto w-full max-w-xl">
        <div class="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <form method="POST" action="{{ route('verification.send') }}" class="space-y-3">
                ...
                <a href="{{ route('login') }}" class="inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
